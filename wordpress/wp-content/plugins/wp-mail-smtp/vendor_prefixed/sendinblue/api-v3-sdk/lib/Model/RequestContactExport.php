...
class RequestContactExport implements \WPMailSMTP\Vendor\SendinBlue\Client\Model\ModelInterface, \ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['exportAttributes' => 'string[]', 'contactFilter' => 'object', 'customContactFilter' => 'WPMailSMTP\\Vendor\\SendinBlue\\Client\\Model\\RequestContactExportCustomContactFilter', 'notifyUrl' => 'string'];
    /**
